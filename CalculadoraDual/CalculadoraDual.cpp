#include "stdafx.h"  //________________________________________ CalculadoraDual.cpp
...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO* pVer)
{
	...
	strcpy_s(pVer->lpszExtensionDesc, HSE_MAX_EXT_DLL_NAME_LEN, "CalculadoraDual ISAPI Extension");
